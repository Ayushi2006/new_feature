        ...
        overlay.current = lib.current
            .geoJSON(p.features, {
                ...
                style: (f) => ({
                    ...
                    weight: f?.properties?.kind === "change" ? 3 : 2,
                    fillOpacity: f?.properties?.kind === "change" ? p.opacity * 0.5 : p.opacity * 0.36,
                    opacity: p.opacity,
                    dashArray: f?.properties?.kind === "urban" ? "5 4" : f?.properties?.kind === "change" ? "3 3" : undefined,
                }),
